...
USAGE_FIELDS = ("input_tokens", "output_tokens", "cached_input_tokens", "reasoning_tokens", "estimated_cost_nano_usd")
NATIVE_SEARCH_NANO_USD = 10_000_000


def token_cost_nanos(model, prompt, completion, cached):
...
class RunCosts:
    ...
    def reserve(self, model, messages, tools=(), *, native_searches=0):
        ...
        if native_searches:
            cost += native_searches * NATIVE_SEARCH_NANO_USD
