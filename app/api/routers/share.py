...
def share_page(request: Request, slug_id: str):
    ...
    response = templates.TemplateResponse(request=request, name="share.html", context={
        ...
        "source_verification": None if watch_page else payload.get("source_verification"),
        "source_check_url": "" if watch_page else f'/api/share/{share_id}/source-check?version={selected_run_id}',
        "model_count": model_count,
        "contradiction_count": contradiction_count,
